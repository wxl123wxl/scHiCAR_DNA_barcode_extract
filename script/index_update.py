...
def update_fastq(r1,r2, out_r1,out_r2 ): ## process two files
    ...
    while True:
        ...
        cell_barcode = cur_r2_name[1:19]
        #umi = cur_r2_name.split(" ",)[-2] 
        #cur_r1_read = cur_r1_read[13:100] ## trim first 31 bp adaptor sequence
        #cur_r2_read = cur_r2_read[13:100] #+ tn5_index_i5 + tn5_index_i7  ## the i5 and i7 index is used for plate demutiplex.
        
        #cur_r2_qual = cur_r2_qual[13:100] # + cur_r1_qual[0:6]+ cur_r2_qual[0:6] ## update quality
        #cur_r1_qual = cur_r1_qual[13:100]
        
        cur_r2_name = cur_r2_name.replace("/1","/2")
        ...
        cur_r1_read = (cell_barcode  + cur_r1_read  ) #+ tn5_index_i5+tn5_index_i7)
        cur_r1_qual = (cell_barcode  + cur_r1_qual  ) #+ tn5_index_i5+tn5_index_i7)
